 ...
 * @author art16
 */
public class JDlgPedidoProduto extends javax.swing.JDialog {
     ...
     */
    public JDlgPedidoProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setSize(680, 230);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgPedidoProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgPedidoProduto dialog = new JDlgPedidoProduto(new javax.swing.JFrame(), true);
