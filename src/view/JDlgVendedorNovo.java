...
public class JDlgVendedorNovo extends javax.swing.JDialog {
    ...
    public RccVendedor rccAlteracao;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id - Vendedor", "Nome Vendedor(a)", "Salario", "E-mail"
            }
        ) {
    ...
    private void jBtnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAlterarActionPerformed
        ...
        rccAlteracao = vendedorController.getBean(rowSel);
    ...
    private void jBtnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnExcluirActionPerformed
        ...
        if (Util.perguntar("Deseja excluir o registro?") == true) {
            rccVendedor = vendedorController.getBean(rowSel);
            vendedor_DAO.delete(rccVendedor);
