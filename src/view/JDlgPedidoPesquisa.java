 ...
 * @author art16
 */
public class JDlgPedidoPesquisa extends javax.swing.JDialog {
     ...
     */
    public JDlgPedidoPesquisa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setTelaAnterior(JDlgVenda jDlgVenda){//método para se conectar com a tela de cadastro de Usuario 
    ...
    private void jBtnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnCancelarActionPerformed
        // TODO add your handling code here:
        Util.mensagem("Consulta cancelada.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgPedidoPesquisa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgPedidoPesquisa dialog = new JDlgPedidoPesquisa(new javax.swing.JFrame(), true);
