...
public class JDlgClientePesquisa extends javax.swing.JDialog {
    ...
    public JDlgClientePesquisa(java.awt.Frame parent, boolean modal) {
        ...
        List lista = cliente_DAO.listALL(); //peguei o list do DAO
        clienteControle.setList(lista);
        jTable1.setModel(clienteControle); 
    }
    
    public void setTelaAnterior(JDlgCliente jDlgCliente){//método para se conectar com a tela de cadastro de Usuario 
        this.jDlgCliente = jDlgCliente; //agora ela sabe que ela é ela msm e a outra é a outra
    }
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        rccCliente = clienteControle.getBean(rowSel);
        jDlgCliente.beanView(rccCliente);
        setVisible(false);
